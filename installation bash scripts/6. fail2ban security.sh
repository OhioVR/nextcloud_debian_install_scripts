...
#this was originally from the nextcloud Raspian project I'm just borrowing it hope you all don't mind

# Fail2ban installation script for Debian VirtualBox
#
